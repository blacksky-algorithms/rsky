...
/** 1 months */
pub const AUTHENTICATED_REFRESH_INACTIVITY_TIMEOUT: u64 = 1 * MONTH;

/** 2 days */
pub const UNAUTHENTICATED_REFRESH_INACTIVITY_TIMEOUT: u64 = 2 * DAY;

/** 1 week */
pub const UNAUTHENTICATED_REFRESH_LIFETIME: u64 = 1 * WEEK;

/** 1 year */
pub const AUTHENTICATED_REFRESH_LIFETIME: u64 = 1 * YEAR;
...
/** 1 minute */
pub const CLIENT_ASSERTION_MAX_AGE: u64 = 1 * MINUTE;
...
/** 1 day */
pub const CODE_CHALLENGE_REPLAY_TIMEFRAME: u64 = 1 * DAY;
