...
impl Queryable<post::SqlType, DB> for Post {
    type Row = (String, String, Option<String>, Option<String>, String);
...
where
    DB: Backend
{
    type SelectExpression = (post::uri, post::cid, post::replyParent, post::replyRoot, post::indexedAt);

    fn construct_selection() -> Self::SelectExpression {
        (post::uri, post::cid, post::replyParent, post::replyRoot, post::indexedAt)
    }
}