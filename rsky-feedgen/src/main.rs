...
const SANDSKY: &str = "at://did:plc:hqmafuxb77d6cepxvqwlcekl/app.bsky.feed.generator/sandsky";
...
> {
    ...
    match feed {
        _sandsky if _sandsky.as_str() == SANDSKY && !is_banned => {
            match rsky_feedgen::apis::get_posts(None, limit, cursor, false, connection).await {
