    ...
    rocket::custom(figment)
        .mount(
            ...
            routes![
                ...
                com::atproto::admin::get_moderation_action::get_moderation_action,
                com::atproto::admin::get_moderation_actions::get_moderation_actions,
                com::atproto::admin::get_moderation_report::get_moderation_report,
                com::atproto::admin::get_moderation_reports::get_moderation_reports,
                com::atproto::admin::get_record::get_record,
                com::atproto::admin::get_repo::get_repo,
                com::atproto::admin::get_subject_status::get_subject_status,
                com::atproto::admin::resolve_moderation_reports::resolve_moderation_reports,
                com::atproto::admin::reverse_moderation_action::reverse_moderation_action,
                com::atproto::admin::search_repos::search_repos,
                com::atproto::admin::send_email::send_email,
                com::atproto::admin::take_moderation_action::take_moderation_action,
